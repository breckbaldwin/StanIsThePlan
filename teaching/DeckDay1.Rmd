...
## Point estimates hide information, posteriors are richer information
 ...
 But lots of ways this could happen: <!--not sure all distros will have +- vals with stated means-->
...
<ul>
  ...
  <li>Bayesian modeling focuses on systeminticlly updating. parameters based on data, e.g., what values of the chosen distribution fit the data the best?</li>
</ul>
